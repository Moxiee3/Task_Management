...
import 'package:schedule_app/Model/model.dart';
              ...
              children: [
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      myCalendar("S", 3, false),
                      myCalendar("M", 4, false),
                      myCalendar("T", 5, false),
                      myCalendar("W", 6, true),
                      myCalendar("T", 7, false),
                      myCalendar("F", 8, false),
                      myCalendar("S", 9, false),
                    ],
                  ),
                ),
                Expanded(
